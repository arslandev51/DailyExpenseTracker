        ...
        <form className='row g-3' onSubmit={handleSubmit}>
          <div className='col-md-4'>
            <div className='input-group'>
              ...
              <input type="date" name="fromdate" className='form-control' value={fromDate} onChange={(e) => setFromDate(e.target.value)} required />
            </div>
          </div>
          ...
          <div className='col-md-4'>
            <div className='input-group'>
              ...
              <input type="date" name="todate" className='form-control' value={toDate} onChange={(e) => setToDate(e.target.value)} required />
            </div>
          </div>
